        ...
        <div className="section-box mt-4" id="portfolio">
            <div className="row">
                <div className="col-12 col-md-10 col-xl-8">
                    <p className="title-heading-titre-six mb-3" data-backdrop-text={portfolioData.mainData.title}>{portfolioData.mainData.title}</p>
                    <h2>{portfolioData.mainData.title2}</h2>
